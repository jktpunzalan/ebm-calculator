...
<div class="shell">
    <header>
        <img src="{{ asset('images/saliksic-header.png') }}" alt="SALIKSIC — Systems and Learning for Inclusive Knowledge and Services in Innovation and Care">
        <div class="fineprint">by JK to MG</div>

        <div class="section-label">Critical Appraisal</div>
        <div class="item">Therapy</div>
        <nav>
            <a class="btn" href="{{ route('therapy.article.form') }}">➕ New Study</a>
            <a class="btn" href="{{ route('therapy.studies.list') }}">📑 View Studies</a>
        </nav>
    </header>

    <footer>
        <p>&copy; {{ date('Y') }} SALIKSIC Project. Some Rights Reserved.</p>
        <p>
            Licensed under
